...
We could start by choosing a wider bandwidth=10 for instance and check for the distribution of predetermined characteristics of households: they should be identical on either side of the cutoff, the smaller the bandwidth we chose.
We should check if the bandwidth=5 is the bandwidth that minimizes the mean square error between actual and estimated treatment effects.
\
